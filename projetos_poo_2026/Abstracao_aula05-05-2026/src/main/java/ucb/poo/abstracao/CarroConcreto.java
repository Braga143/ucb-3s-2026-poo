...
public class CarroConcreto extends VeiculoAbstrato {
    ...
    public void frear(double decremento) {
        ...
        System.out.println("Carro freando... Velocidade atual: " + frenagem + " km/h");
    ...
    public void exibirInformacoes() {
        ...
        System.out.println("Potencia do motor: " + potenciaMotor + " cv");
        System.out.println("Velocidade atual: " + velocidadeAtual + " km/h");
        System.out.println("Status: " + (ligado ? "Ligado" : "Desligado"));
        System.out.println("Ar condicionado: " + (arCondicionado ? "Ligado" : "Desligado"));
        System.out.println("Combustivel: " + combustivelAtual + "/" + capacidadeTanque + " litros");
    }
